...
import type { AddonGroupDto, ServiceDetail as ServiceDetailDto } from '@reset/api-client';
import {
  Button,
  ErrorState,
  Skeleton,
...
export function ServiceDetail({
  ...
  slug: string;
  /**
   * The service, already fetched on the server.
   *
   * This is what puts the treatment's name, price and duration into the HTML a crawler
   * receives. Without it react-query starts empty, renders skeletons, and the page Google
   * indexes describes nothing. `null` when the server read failed — the query then behaves
   * exactly as it used to and fetches on the client.
   */
